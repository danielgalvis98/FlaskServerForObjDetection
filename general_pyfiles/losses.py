'''
File that contains the 4 losses that are used to optimize the Faster-RCNN, as specified on the original paper.
The code has been taken from https://github.com/you359/Keras-FasterRCNN
'''
